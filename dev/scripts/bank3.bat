...
bmp2tile.exe raw\guardB\Idle.png -savetiles "guardB_idle (tiles).psgcompr" -noremovedupes -planar -tileoffset 140 -savetilemap "guardB_idle (tilemap).bin" -exit
bmp2tile.exe raw\guardC\Idle.png -savetiles "guardC_idle (tiles).psgcompr" -noremovedupes -planar -tileoffset 152 -savetilemap "guardC_idle (tilemap).bin" -exit
bmp2tile.exe raw\guardD\Idle.png -savetiles "guardD_idle (tiles).psgcompr" -noremovedupes -planar -tileoffset 164 -savetilemap "guardD_idle (tilemap).bin" -exit
