...
source\content_manager.rel	source\font_manager.rel		source\text_manager.rel	    source\memo_manager.rel     source\delay_manager.rel ^
...
source\state_manager.rel	source\stats_manager.rel	source\scroll_manager.rel ^
