...
REM Sprites
bmp2tile.exe Sprites\Player_Idle.png -savetiles "Player_Idle (tiles).psgcompr" -noremovedupes -planar -tileoffset 0 -savepalette "Sprites (palette).bin" -fullpalette  -spritepalette -exit
