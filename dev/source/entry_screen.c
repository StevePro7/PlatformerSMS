...
void screen_entry_screen_load()
{
	...
	engine_font_manager_draw_text( LOCALE_ENTRY_OPT1, TEXT_X + 3, TEXT_Y + 1 );
	engine_font_manager_draw_text( LOCALE_ENTRY_OPT2, TEXT_X + 3, TEXT_Y + 2 );
	display_options();
}
